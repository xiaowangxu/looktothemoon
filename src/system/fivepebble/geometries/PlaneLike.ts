...
export interface PlaneLike<Vec extends VectorLike<Vec, Mat>, Mat extends MatrixLike<Mat>> extends GeometryLike<Vec, Mat>, GeometryLikeBounded<Vec, Mat> {
    get normal(): Vec;
    get distance(): number;
    ...
    set(normal: Vec, distance: number): PlaneLike<Vec, Mat>;
}
