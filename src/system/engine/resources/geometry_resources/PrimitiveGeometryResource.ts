...
export class BoxGeometryResource extends PrimitiveGeometryResource {
	...
	public build() {
		...
		const position_buffer = new RenderDeviceVector3AttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw,
			[
				// top
		...
		const normal_buffer = new RenderDeviceVector3AttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw,
			[
				// top
				vec3(0, 1, 0),
				vec3(0, 1, 0),
		...
		const uv_buffer = new RenderDeviceVector2AttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw,
			[
				// top
				vec2(1, 0),
				vec2(1, 1),
		...
		const index_buffer = new RenderDeviceIndexAttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw,
			[
				// top
				0, 1, 2, 2, 1, 3,
				// bottom
...
export class TorusGeometryResource extends PrimitiveGeometryResource {
	...
	public build() {
		...
		const position_buffer = new RenderDeviceVector3AttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw, vertex_count);
		const normal_buffer = new RenderDeviceVector3AttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw, vertex_count);
		const uv_buffer = new RenderDeviceVector2AttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw, vertex_count);
		...
		const index_buffer = new RenderDeviceIndexAttributeBuffer(RenderServer3D, RenderStateBufferUsage.StaticDraw, index_count);
