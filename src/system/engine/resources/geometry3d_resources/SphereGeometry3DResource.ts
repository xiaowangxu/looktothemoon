...
export class SphereGeometry3DResource extends Geometry3DResource {
    ...
    private readonly position_buffer_ref: Ref<WebGPURenderElementVector3Buffer> = new Ref(new WebGPURenderElementVector3Buffer(RenderServer.render_state, WebGPURenderStateBufferType.VertexArray, WebGPURenderStateBufferUsage.CopyDst, 24));
    private readonly normal_buffer_ref: Ref<WebGPURenderElementVector3Buffer> = new Ref(new WebGPURenderElementVector3Buffer(RenderServer.render_state, WebGPURenderStateBufferType.VertexArray, WebGPURenderStateBufferUsage.CopyDst, 24));
    private readonly uv_buffer_ref: Ref<WebGPURenderElementVector2Buffer> = new Ref(new WebGPURenderElementVector2Buffer(RenderServer.render_state, WebGPURenderStateBufferType.VertexArray, WebGPURenderStateBufferUsage.CopyDst, 24));
    private readonly index_buffer_ref: Ref<WebGPURenderElementIndexBuffer> = new Ref(new WebGPURenderElementIndexBuffer(RenderServer.render_state, WebGPURenderStateBufferType.Index, WebGPURenderStateBufferUsage.None, [
        // top
        0, 1, 2, 2, 1, 3,
        // bottom
        4, 6, 5, 5, 6, 7,
