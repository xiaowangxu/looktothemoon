...
export class ClassBinaryEncoder extends ClassEncoder<ArrayBuffer, ClassBinaryEncoderOption> {
    ...
    static readonly #ascii_ragex: RegExp = /^[\x00-\x7F]*$/;

    static readonly #header_title = new Uint8Array([76, 84, 84, 77, 32, 66, 73, 78]);
    static readonly #md5_array_buffer = new Uint8Array(16);
    static readonly #md5_hex_byte_map: Record<string, number> = {
...
export class ClassBinaryDecoder extends ClassDecoder<ArrayBuffer, ClassBinaryDecoderOption> {
    static readonly #md5_byte_hex_map = [
