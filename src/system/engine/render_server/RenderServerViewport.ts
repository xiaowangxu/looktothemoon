...
export class RenderServerViewport {
    ...
    public set_WorldEnvUniform(camera_world: Matrix4, camera_projection: Matrix4, camera_is_orthogonal: boolean, screen_width: number, screen_height: number, time: number, pixel_ratio_override?: number) {
        // camera world
        {
