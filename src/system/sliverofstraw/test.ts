...
o_color = vec4(mix(texture(u_result, uv).rgb, texture(u_result1, uv).rgb, 0.5), 1.0);`
);
...
const frame_buffer_tex1 = render_device.render_state.create_Texture(RenderStateTextureType.Tex2D, true, RenderStateTextureFormat.RGBA32F, 1, undefined, undefined, undefined, RenderStateTextureMinFilter.Nearest, RenderStateTextureMagFilter.Nearest).expect();
render_device.render_state.alloc_Texture2D(frame_buffer_tex1, 2048, 2048, 0, undefined);
...
render_device.render_state.set_FrameBufferAttachment(frame_buffer, WebGL2RenderStateFrameBufferAttachmentPoint.Color0, frame_buffer_tex);
render_device.render_state.set_FrameBufferAttachment(frame_buffer, WebGL2RenderStateFrameBufferAttachmentPoint.Color1, frame_buffer_tex1);
...
quad_material.set_Uniform<RenderStateValueType.Tex2D>('test', 'u_result1', frame_buffer_tex1);
