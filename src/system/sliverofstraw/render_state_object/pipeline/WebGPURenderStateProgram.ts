...
export class WebGPURenderStateProgram extends WebGPURenderObjectRefCounted {
    ...
    public readonly vertex_or_compute_shader_ref: ReadonlyRef<WebGPURenderStateShader>;
    public readonly fragment_shader_ref: Ref<WebGPURenderStateShader>;
    ...
    constructor(render_state: WebGPURenderState, vertex_or_compute_shader: WebGPURenderStateShader, frag_shader?: WebGPURenderStateShader) {
        super(render_state);
        this.vertex_or_compute_shader_ref = new ReadonlyRef(vertex_or_compute_shader);
        this.fragment_shader_ref = new Ref(frag_shader);
    }
