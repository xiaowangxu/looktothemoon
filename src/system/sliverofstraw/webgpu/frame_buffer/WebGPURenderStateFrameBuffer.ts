...
import { RenderStateFrameBuffer } from "../../render_state/frame_buffer/RenderStateFrameBuffer";
...
export class WebGPURenderStateFrameBuffer extends RenderStateFrameBuffer<WebGPURenderState> {
